      ...
      <div class="ld-dock-pane-inner">
        <div class="ld-dock-pane-head">
          ...
          <div class="ld-dock-pane-actions">
            ...
            <template v-else-if="pane === 'dataSources'">
              <button class="ld-add-head-btn" title="Add a text data source (a shared string)" @click="addDataSource('text')">
                <Plus :size="13" /> Text
              </button>
              <button class="ld-add-head-btn" title="Add a list data source (rows a layout container repeats its template over)" @click="addDataSource('list')">
                <Plus :size="13" /> List
              </button>
            </template>
