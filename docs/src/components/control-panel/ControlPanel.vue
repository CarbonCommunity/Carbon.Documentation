...
import MapTab from './ControlPanel.Tabs.Map.vue'
...
const subTabs = [
  ...
  {
    Name: 'Map',
    Description: 'That\'s a cool map.',
    IsDisabled: () => !selectedServer.value?.Bridge || !selectedServer.value?.hasPermission('map_view')
  }
]
